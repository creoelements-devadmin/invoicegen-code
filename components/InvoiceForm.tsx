...
const LOGO_OPTIONS = [
  { label: 'Creo Elements', url: '/invoicegen/creo-logo.png' },
  { label: 'Little Things', url: '/invoicegen/Little Things Cute.png' },
  { label: 'ArtAngle90', url: '/invoicegen/artangle90.png' },
  { label: 'StoreEva', url: '/invoicegen/storeeva.jpg' },
];
